...
namespace HomeInventory {
    ...
    public partial class ItemDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemDataTable : global::System.Data.TypedTableBase<ItemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemRow AddItemRow(string ItemName, string Unit, string Quantity) {
...
namespace HomeInventory.ItemDataSetTableAdapters {
    ...
    public partial class ItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Item` WHERE ((`ItemID` = ?) AND ((? = 1 AND `ItemName` IS NULL) OR (" +
                "`ItemName` = ?)) AND ((? = 1 AND `Unit` IS NULL) OR (`Unit` = ?)) AND ((? = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Item` (`ItemName`, `Unit`, `Quantity`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Item` SET `ItemName` = ?, `Unit` = ?, `Quantity` = ? WHERE ((`ItemID` = ?" +
                ") AND ((? = 1 AND `ItemName` IS NULL) OR (`ItemName` = ?)) AND ((? = 1 AND `Unit" +
                "` IS NULL) OR (`Unit` = ?)) AND ((? = 1 AND `Quantity` IS NULL) OR (`Quantity` =" +
                " ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HomeInventory.Properties.Settings.Default.ItemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemID, ItemName, Unit, Quantity FROM Item";
        ...
        public virtual int Delete(int Original_ItemID, string Original_ItemName, string Original_Unit, string Original_Quantity) {
        ...
        public virtual int Insert(string ItemName, string Unit, string Quantity) {
            if ((ItemName == null)) {
        ...
        public virtual int Update(string ItemName, string Unit, string Quantity, int Original_ItemID, string Original_ItemName, string Original_Unit, string Original_Quantity) {
            if ((ItemName == null)) {
